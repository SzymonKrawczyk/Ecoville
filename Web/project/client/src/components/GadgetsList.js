...
import GadgetTable from "./GadgetTable"

import {ACCESS_LEVEL_GUEST, ACCESS_LEVEL_ADMIN, SERVER_HOST} from "../config/global_constants"

export default class GadgetsList extends Component {
    ...
    componentDidMount() {
        ...
        axios.post(`${SERVER_HOST}/gadgetsList/`)
        .then(res =>  {
            ...
            if(res.data) {
                ...
                if (res.data.errorMessage) {
                    ...
                    this.setState({gadgetTable: res.data}) 
                }   
            } else {
    ...
    render() {   
		...
		document.title = 'Ecoville | Gadgets'	
        return (           
